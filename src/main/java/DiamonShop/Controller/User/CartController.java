...
public class CartController extends BaseController {
	...
	public String AddCart(HttpServletRequest request, HttpSession session, @PathVariable long id) {
		...
		session.setAttribute("TotalQuantyCar", cartService.TotalQuanty(cart));
		session.setAttribute("TotalPriceCar", cartService.TotalPrice(cart));
	...
	public String CheckOutBill(HttpServletRequest request, HttpSession session, @ModelAttribute("bills") Bills bill) {
		// String a = (String) session.getAttribute("TotalPriceCar");
		// String b = (String) session.getAttribute("TotalQuantyCar");
		String a = "1000000";
		String b = "3";
		// bill.setQuanty(Integer.parseInt((String)
		// session.getAttribute("TotalPriceCar")));
		// double d = Double.parseDouble((String)
		// session.getAttribute("TotalQuantyCar"));
		// bill.setTotal(d);
		bill.setQuanty(Integer.parseInt(a));
